...
public class EmployeeFactoryTest {
     ...
     * key        value
     * ---        -----
     * type       HE or SE  -> NOTE: this is the "indicator" tells factory which type of employee to create
     * name       Jackie
     * hireDate   1990-08-24
     * <p>
     * salary     50000.00
    ...
    public void createEmployee_shouldReturnSalariedEmployee_whenTypeSE() {
        ...
        // EXACT type match -- using instanceof would be an IS-A check -- not good
        assertEquals(SalariedEmployee.class, emp.getClass());
    ...
    public void createEmployee_shouldReturnHourlyEmployee_whenTypeHE() {
        ...
        // for class objects and ENUMS we can use ==
        assertTrue(HourlyEmployee.class == emp.getClass());
    ...
    public void createEmployee_shouldThrowIllegalArgumentException_whenInvalidType() {
        seMap.put("type", "INVALID_TYPE"); // keys are unique, putting another overrides the original
