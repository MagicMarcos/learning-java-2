...
public class WildcardTest {
     ...
     * even though Double IS-A subclass of Number, Collection<Double> IS NOT a subclass of Collection<Number>
     * Collection is the limiting factor here -> but we can change what's in the diamond to be more flexible
     * and accept subclasses
     */
    ...
    // wild card syntax means -> collection of anything AS-LONG-AS it IS-A Number.
    // so Double IS-A Number and therefore it works
