...
public class CatalogTest {
    ...
    @Test
    public void sortByIncreasingVolume() {
        ...
        // tvList.sort((tv1,tv2) -> Integer.compare(tv1.getVolume(), tv2.getVolume()));
    ...
    @Test
    public void findTheLoudestUsingCollectionsDotMax() {
        Collection<Television> tvs = Catalog.getInventory();
        Television loudest = Collections.max(tvs, new Comparator<Television>() {
            @Override
            public int compare(Television tv1, Television tv2) {
                return Integer.compare(tv1.getVolume(), tv2.getVolume());
            }
        ...
        // Television loudest = Collections.max(tvs, (tv1, tv2) -> Integer.compare(tv1, tv2));
        // Television loudestTv = Collections.max(tvs, Comparator.comparingInt(Television::getVolume));
