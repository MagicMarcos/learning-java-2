...
public class TelevisionTestSort {
    ...
    public static void main(String[] args) {
        ...
        tvList.sort(null); // passing null means "sort by natural order"
        ...
        // sort by Comparator (Television Channel Comparator)
        ...
        // sort by Comparator. If tied on brand, sort by channel
    ...
    private static List<Television> createTelevisionList() {
        ...
        // convenient way to assemble these into a list (vs. 6 calls to add())
